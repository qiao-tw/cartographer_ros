...
TRAJECTORY_BUILDER_3D.high_resolution_adaptive_voxel_filter.min_num_points = 100 -- 150 -- the lower, the faster
TRAJECTORY_BUILDER_3D.high_resolution_adaptive_voxel_filter.max_length = 8. -- the higher, the faster
TRAJECTORY_BUILDER_3D.high_resolution_adaptive_voxel_filter.max_range = 15. -- the lower, the faster
TRAJECTORY_BUILDER_3D.low_resolution_adaptive_voxel_filter.min_num_points = 150 -- the lower, the faster
TRAJECTORY_BUILDER_3D.low_resolution_adaptive_voxel_filter.max_length = 16.
TRAJECTORY_BUILDER_3D.low_resolution_adaptive_voxel_filter.max_range = MAX_3D_RANGE
TRAJECTORY_BUILDER_3D.voxel_filter_size = 0.3 -- 0.15 -- the larger, the faster
TRAJECTORY_BUILDER_3D.submaps.high_resolution = 0.10 -- the larger, the faster
TRAJECTORY_BUILDER_3D.submaps.high_resolution_max_range = 40.
TRAJECTORY_BUILDER_3D.submaps.low_resolution = 0.5 -- 1.0
...
POSE_GRAPH.optimize_every_n_nodes = 0 -- turn off global SLAM to not mess with tuning
...
POSE_GRAPH.constraint_builder.sampling_ratio = 0.02 -- 0.03 -- the lower, the faster
POSE_GRAPH.constraint_builder.global_localization_min_score = 0.66
POSE_GRAPH.constraint_builder.min_score = 0.2 -- for fast correlative scan matcher
