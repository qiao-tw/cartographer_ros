...
POSE_GRAPH.global_constraint_search_after_n_seconds = 999999999
POSE_GRAPH.constraint_builder.global_localization_min_score = 0.6

-- "local" is within the same trajectory
POSE_GRAPH.constraint_builder.sampling_ratio = 0.5 -- 0.3
POSE_GRAPH.optimization_problem.ceres_solver_options.max_num_iterations = 20
POSE_GRAPH.constraint_builder.min_score = 0.3 -- 0.62 -- for fast correlative scan matcher
