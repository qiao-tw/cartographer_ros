...
options = {
  ...
  unique_ecef_to_local_frame = false,
}
...
TRAJECTORY_BUILDER_3D.high_resolution_adaptive_voxel_filter.max_length = 4.
...
MAP_BUILDER.num_background_threads = 147
...
POSE_GRAPH.constraint_builder.min_score = 0.57 -- 0.62 -- for fast correlative scan matcher
POSE_GRAPH.constraint_builder.fast_correlative_scan_matcher_3d.min_rotational_score = 0.95 -- 0.5
POSE_GRAPH.constraint_builder.fast_correlative_scan_matcher_3d.min_low_resolution_score = 0.75
