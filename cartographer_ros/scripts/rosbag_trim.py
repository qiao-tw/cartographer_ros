...
def main():
    ...
    parser = argparse.ArgumentParser(description='Trim a bagfile with the possibilities of filtering topics.')
    parser.add_argument('outputbag',
                        help='output bag file with topics trimmed')
    ...
    #TODO: apply time to trim the file...
